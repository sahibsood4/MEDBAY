...
def update_Item(request):
    ...
    customer = request.user.customer  # Ensure this is correct
...
def chat(request):
    if request.method == "POST":
        ...
        try:
            # Use the ChatCompletion endpoint with correct parameters
        ...
        # Handle unexpected errors
            ...
            return JsonResponse({'response': f'An unexpected error occurred: {str(e)}'}, status=500)

    # If the request is not POST, render the chat page
